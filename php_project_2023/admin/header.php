		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
		    ...
		    <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="dashboard.php" class=" hvr-bounce-to-right"><i class="fa fa-dashboard nav_icon "></i><span class="nav-label">Admin Dashboards</span> </a>
                    </li>
                   
                    <li>
                        <a href="#" class=" hvr-bounce-to-right"><i class="fa fa-indent nav_icon"></i> <span class="nav-label">Service Provider</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="add_emp.php" class=" hvr-bounce-to-right"> <i class="fa fa-user nav_icon"></i>Add Service Provider</a></li>
                            
                            <li><a href="manage_emp.php" class=" hvr-bounce-to-right"><i class="fa fa-user nav_icon"></i>Manage Provider</a></li>		
					   </ul>
                    </li>
